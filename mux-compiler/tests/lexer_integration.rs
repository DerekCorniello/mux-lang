...
fn test_file_lexer() {
    let passing_cases = [
        ...
        (
            ...
            vec![
                Id("import".to_string()), Id("math".to_string()), NewLine,
                Id("import".to_string()), Id("utils".to_string()), Dot, Id("logger".to_string()), As, Underscore, NewLine,
 NewLine,
                Const, Id("int".to_string()), Id("MAX".to_string()), Eq, Int(100), NewLine,
                Let, Id("flt".to_string()), Eq, Float(7.82), NewLine,
                Let, Id("message".to_string()), Eq, Str("Mux Parser Test".to_string()), NewLine,
 NewLine,
 ...
 NewLine,
                Interface, Id("Drawable".to_string()), OpenBrace, Func, Id("draw".to_string()), OpenParen, CloseParen, Returns, Id("void".to_string()), CloseBrace, NewLine,
 NewLine,
 ...
 NewLine,
                ...
                Let, OpenParen, Id("a".to_string()), Comma, Underscore, CloseParen, Eq, OpenParen, Int(1), Comma, Int(2), CloseParen, NewLine,
 NewLine,
 ...
 NewLine,
                ...
                For, Id("shape".to_string()), In, Id("shapes".to_string()), OpenBrace, Id("shape".to_string()), Dot, Id("draw".to_string()), OpenParen, CloseParen, CloseBrace, NewLine,
 NewLine,
                ...
                Let, Id("popped".to_string()), Eq, Id("stack".to_string()), Dot, Id("pop".to_string()), OpenParen, CloseParen, NewLine,
 NewLine,
                Let, Id("res".to_string()), Eq, Id("divide".to_string()), OpenParen, Int(10), Comma, Int(2), CloseParen, NewLine,
 ...
 NewLine,
                ...
                Match, Id("maybeEven".to_string()), OpenBrace, Id("Some".to_string()), OpenParen, Id("v".to_string()), CloseParen, OpenBrace, Id("print".to_string()), OpenParen, Id("v".to_string()), CloseParen, CloseBrace, Id("None".to_string()), OpenBrace, Id("print".to_string()), OpenParen, Str("None".to_string()), CloseParen, CloseBrace, CloseBrace, NewLine,
 NewLine,
                ...
                Let, Id("squared".to_string()), Eq, Id("map".to_string()), OpenParen, OpenBracket, Int(1), Comma, Int(2), Comma, Int(3), CloseBracket, Comma, Id("square".to_string()), CloseParen, NewLine,
 NewLine,
                Id("int".to_string()), Id("val".to_string()), Eq, Int(10), NewLine,
                Let, Id("p".to_string()), Eq, Ampersand, Id("val".to_string()), NewLine,
                Star, Id("p".to_string()), Eq, Int(20), NewLine,
